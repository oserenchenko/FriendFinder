...
for (var i = 0; i < surveyQ.length; i++) {
  var qNum = $("<h3>Question #" + (i + 1) + "</h3>");
  var newQ = $("<p class='newQ'>" + surveyQ[i] + "</p>");
  var newDropDown = '<div class="col-auto my-1"> <select class="custom-select mr-sm-2" id="inlineFormCustomSelect"> <option selected>Select and Option</option> <option value="1">1 (Strongly Disagree)</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5 (Strongly Agree)</option> </select> </div>'
